...
const LeftPanel = ({ onItemClick }) => {
    ...
    const handleResumeDownload = () => {
        const resumeUrl = 'https://github.com/user-attachments/files/17661878/Ashwini.Patil.Resume.pdf'; // Raw URL to your resume file
        const link = document.createElement('a');
        link.href = resumeUrl;
        link.setAttribute('download', 'Ashwini Patil Resume.pdf'); // Adjust filename as needed
    ...
    return (
        <div className="dp-left-panel">
            <ImageContainer />
            <div className="dp-left-panel__my-name">Ashwini Patil</div>
